...
public class AdvancedFragment extends Fragment {
    ...
    private void initData() {
        ...
        Tutorial tutorial1 = new Tutorial("Third", 4, R.drawable.ic_circle_zero, 2, tcontent1);
        Tutorial tutorial2 = new Tutorial("Fourth", 5, R.drawable.ic_circle_zero, 2, tcontent2);
